...
class ProductosPorCategoriaRepository {
    ...
    fun getProductosPorCategoria(categoriaId: Int): List<Producto> {
        // Aquí simulas obtener los productos por categoría desde una API o base de datos
        return when (categoriaId) {
            ...
            4 -> listOf(
                Producto(19, "Vestido de fiesta", 79.99, "Elegante vestido de fiesta para mujeres", "imagen_url"),
